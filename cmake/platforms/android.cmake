...
set(PLUMBUM_PLATFORM_LIBS_BIN_PREFIX ${CMAKE_SOURCE_DIR}/libs/tools)
set(PLUMBUM_PLATFORM_LIBS_PREFIX ${CMAKE_SOURCE_DIR}/libs/${ANDROID_LIB_ARCH}-android)
...
set(APK_PACKAGE_NAME "net.plumbum.plumbum")
set(APK_PACKAGE_VERSION "v${PLUMBUM_VERSION_STRING}")
set(APK_DISPLAY_NAME "Plumbum")
