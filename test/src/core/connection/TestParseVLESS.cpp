...
TEST_CASE("Test VLESS URL Parsing")
{
    ...
    {
        const static auto url = "vless://b0dd64e4-0fbd-4038-9139-d1f32a68a0dc@plumbum.net:3279?security=xtls&flow=rprx-xtls-splice#VLESSTCPXTLSSplice";
    ...
    {
        const static auto url = "vless://24a613c1-de83-4c63-ba73-a9d08c88fec3@plumbum.net:13432?security=xtls&alpn=h2%2Chttp%2F1.1";
    ...
    {
        const static auto url = "vless://6d76fa31-8de2-40d4-8fee-6e61339c416f@plumbum.net:123?type=grpc&security=tls&serviceName=FuckGFW&mode=multi";
        const auto result = vless::Deserialize(url, &alias, &errMessage);
